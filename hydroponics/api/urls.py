...
urlpatterns = [
    ...
    path('systems/<int:system_id>/measurements/',
         MeasurementView.as_view(), name='measurement_list'),
    path('systems/<int:system_id>/measurements/<int:measurement_id>/',
         MeasurementView.as_view(), name='measurement_detail'),
]
